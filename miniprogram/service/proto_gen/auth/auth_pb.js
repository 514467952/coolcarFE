...
export const auth = $root.auth = (() => {
    ...
    auth.v1 = (function() {
        ...
        v1.LoginRequest = (function() {
             ...
             * @static
             * @param {auth.v1.ILoginRequest=} [properties] Properties to set
             * @returns {auth.v1.LoginRequest} LoginRequest instance
             */
            ...
            /**
             * Encodes the specified LoginRequest message, length delimited. Does not implicitly {@link auth.v1.LoginRequest.verify|verify} messages.
        ...
        v1.LoginResponse = (function() {
             ...
             * @property {number|null} [expiresInSec] LoginResponse expiresInSec
             */
            ...
            /**
             * LoginResponse expiresInSec.
             * @member {number} expiresInSec
             * @memberof auth.v1.LoginResponse
             * @instance
             */
            LoginResponse.prototype.expiresInSec = 0;
            ...
            LoginResponse.encode = function encode(message, writer) {
                ...
                if (message.expiresInSec != null && Object.hasOwnProperty.call(message, "expiresInSec"))
                    writer.uint32(/* id 2, wireType 0 =*/16).int32(message.expiresInSec);
                return writer;
            };

            /**
             * Encodes the specified LoginResponse message, length delimited. Does not implicitly {@link auth.v1.LoginResponse.verify|verify} messages.
             * @function encodeDelimited
             * @memberof auth.v1.LoginResponse
             * @static
             * @param {auth.v1.ILoginResponse} message LoginResponse message or plain object to encode
            ...
            LoginResponse.verify = function verify(message) {
                ...
                if (message.expiresInSec != null && message.hasOwnProperty("expiresInSec"))
                    if (!$util.isInteger(message.expiresInSec))
                        return "expiresInSec: integer expected";
                return null;
            };
            ...
            LoginResponse.fromObject = function fromObject(object) {
                ...
                if (object.expiresInSec != null)
                    message.expiresInSec = object.expiresInSec | 0;
                return message;
            };
            ...
            LoginResponse.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    object.accessToken = "";
                    object.expiresInSec = 0;
                }
                if (message.accessToken != null && message.hasOwnProperty("accessToken"))
                    object.accessToken = message.accessToken;
                if (message.expiresInSec != null && message.hasOwnProperty("expiresInSec"))
                    object.expiresInSec = message.expiresInSec;
                return object;
            };
